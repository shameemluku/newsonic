...
export const getCreatorPosts = (channelId,filter,limit)=> async (dispatch) =>{
    try {
...
export const updatePostText = (data,showToast) => async (dispatch,getState) =>{
    try {
...
export const updatePostCategory = (data,showToast) => async (dispatch,getState) =>{
    try {
...
export const updatePostIsComment = (data,showToast) => async (dispatch,getState) =>{
    try {
...
export const updatePostIsMonetize = (data,showToast) => async (dispatch,getState) =>{
    try {
...
export const updateChannelData = (data,showToast,setEnableEdit) => async (dispatch,getState) =>{
    try {
...
export const updateChannelImage = (data,showToast,setEnableEdit) => async (dispatch,getState) =>{
    try {
