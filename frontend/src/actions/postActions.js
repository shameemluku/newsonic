...
export const getPostDetails = (postId)=> async (dispatch,getState) =>{
    try {
        ...
        const {data} = await api.fetchPostDetails(postId,await generateSignature())
...
export const postComment = (commentData,setEmpty)=> async (dispatch,useState) =>{
    try {
...
export const deletePost = (deleteIDs,deleteImages,channelId,setStatus) => async (dispatch,getState) =>{
    try {
        ...
        let {data} = await api.deletePost({deleteIDs,deleteImages},channelId) 
        if(data.status){
...
export const deleteDraft = (deleteIDs,channelId,setStatus) => async (dispatch,getState) =>{
    try{
