    ...
    <>
      ...
      <div className="d-flex flex-column">
        ...
        <div className="mainContent mb-5">
          {!channelCreate.loading && <div className="profile-holder d-flex justify-content-end">
          ...
          { !channelCreate.loading ?
            ...
            <TextField
              ...
              onChange={(e)=>setFormData((prevState)=>({...prevState,channelName:e.target.value}))}
            />

            {status.loading && (
              <span className="check-avail">
                <CircularProgress color="success" className="avail-loader" />
            ...
            <TextField
              ...
              onChange={(e)=>setFormData((prevState)=>({...prevState,website:e.target.value}))}
            />

            <Form.Group controlId="channel-files" className="mb-3 mt-4 w-100">
            ...
            <Row>
              ...
              <Col className="d-flex justify-content-end" md={12}>
                <Button variant="contained" className="creator-submit-btn"
          ...
          <div className="loading-section mt-5">
            <div className="content-center">
              <span>
              <div>Creator</div>
              <img src={logo} alt="" className="creator-logo"></img></span>
            </div>
            ...
            <div className="content-center mb-5">
              <span>Please wait...  Creating your channel &nbsp; <b>{progress}%</b></span>
            </div>
